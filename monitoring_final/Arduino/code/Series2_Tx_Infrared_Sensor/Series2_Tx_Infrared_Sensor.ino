...
//Access the webpage http://blogs.msdn.com/b/abhinaba/archive/2013/04/30/arduino-fun-door-entry-alarm.aspx
//for more information about the pins
#define SENSOR_PIN A0  // Photo-resistor pin
...
int statusLed = 13;
int errorLed = 13;
//Variables for reading the inputs
int sensorVal,controlVal;
...
void loop() {   
  ...
  controlVal = analogRead(CONTROL_PIN);
